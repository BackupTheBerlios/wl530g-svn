...
/*
inline void l2tp_memcpy(void *buf_d, void *buf_s, int len)
{
	int x;
	//_u16 *dst = (_u16 *) buf_d;
	//_u16 *src = (_u16 *) buf_s;
...
//Add by SJ_Yen May.10,2005
inline void super_safe_copy (char *a, char *b, int size)
{
    /* Copies B into A (assuming A holds MAXSTRLEN bytes)
       safely */
	int x;
