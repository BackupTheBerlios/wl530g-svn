...
<tr>
<td class="content_desc_td" colspan="2">LAN to WAN過濾讓您可封鎖LAN與WAN之間的指定封包。首先，您可定出過濾程式將會啟用的日期及時間。接著，您可選擇過濾程式在兩種方向所適用的預設動作並插入適合任何例外條件的規則。
         </td>
</tr>
...
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LWFilterList', 16, ' Add ');" name="LWFilterList" value="新增" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LWFilterList', 16, ' Del ');" name="LWFilterList" value="刪除" size="12">
</div>
</td><td width="10%">
<div align="center">
...
<td></td><td class="content_list_field_header_td" colspan="">來源IP	                
           	        ...
           	        </td><td class="content_list_field_header_td" colspan="">說明	                
           	        </td><td></td>
</tr>
<tr>
